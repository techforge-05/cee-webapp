<template>
  <div class="min-h-screen bg-white">
    ...
    >
      <div class="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <h1 class="text-4xl md:text-5xl font-bold mb-4">
          {{ $t('support.projectDetails.multipurposeCenter.title') }}
        </h1>
        <p class="text-xl md:text-2xl text-red-100">
          {{ $t('support.projectDetails.multipurposeCenter.subtitle') }}
        </p>
      </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
      <div class="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div class="bg-gradient-to-br from-red-100 to-orange-100 rounded-2xl h-64 md:h-96 flex items-center justify-center">
          <UIcon
        ...
        <div class="grid lg:grid-cols-3 gap-12">
          ...
          <div class="lg:col-span-2">
            <p class="text-xl text-gray-700 leading-relaxed mb-8">
              {{ $t('support.projectDetails.multipurposeCenter.description') }}
            </p>
            ...
            <ul class="space-y-4">
              ...
              >
                ...
                />
                <span class="text-gray-700">{{ $rt(need) }}</span>
              </li>
            </ul>
          </div>
            ...
            <div class="bg-orange-50 rounded-xl p-6 sticky top-24">
              ...
              <div class="mb-6">
                ...
                <p class="text-gray-700">
                  {{ $t('support.projectDetails.multipurposeCenter.goal') }}
                </p>
              </div>
...
const needs = computed(() => {
  return tm('support.projectDetails.multipurposeCenter.needs') as any[];
});

useHead({
  title: 'Multipurpose Center Project - CEE',
  meta: [
    {
      name: 'description',
      content:
        'Learn about our Multipurpose Center project and how you can help make this facility a reality for our school community.',
    },
  ],
});
</script>
