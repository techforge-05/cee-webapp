<template>
  <div class="min-h-screen bg-white">
    ...
    >
      <div class="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <h1 class="text-4xl md:text-5xl font-bold mb-4">
          {{ $t('support.projectDetails.libraryFloor.title') }}
        </h1>
        <p class="text-xl md:text-2xl text-red-100">
          {{ $t('support.projectDetails.libraryFloor.subtitle') }}
        </p>
      </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
      <div class="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div class="bg-gradient-to-br from-emerald-100 to-teal-100 rounded-2xl h-64 md:h-96 flex items-center justify-center">
          <UIcon
            name="i-heroicons-book-open"
            class="w-32 h-32 text-emerald-400"
          />
        </div>
      </div>
    </section>
        ...
        <div class="grid lg:grid-cols-3 gap-12">
          ...
          <div class="lg:col-span-2">
            <p class="text-xl text-gray-700 leading-relaxed mb-8">
              {{ $t('support.projectDetails.libraryFloor.description') }}
            </p>
          ...
          <div class="lg:col-span-1">
            <div class="bg-emerald-50 rounded-xl p-6 sticky top-24">
              <div class="mb-6">
                ...
                <UBadge color="warning" variant="subtle" size="lg">
                  {{ $t('support.projectDetails.libraryFloor.status') }}
                </UBadge>
              </div>
              ...
              <div class="mb-6">
                ...
                <p class="text-gray-700">
                  {{ $t('support.projectDetails.libraryFloor.goal') }}
                </p>
              </div>
...
const needs = computed(() => {
  return tm('support.projectDetails.libraryFloor.needs') as any[];
});

useHead({
  title: 'Library Floor Project - CEE',
  meta: [
    {
      name: 'description',
      content:
        'Learn about our Library Floor renovation project to create a more welcoming reading space for students.',
    },
  ],
});
</script>
